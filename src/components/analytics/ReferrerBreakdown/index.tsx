...
import type { ReferrerCategory } from '@/types/analytics'

interface ReferrerBreakdownProps {
  data: Record<ReferrerCategory, number>
}
...
export default function ReferrerBreakdown({ data }: ReferrerBreakdownProps) {
  ...
  const chartData = (Object.entries(data) as [ReferrerCategory, number][])
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4">
          <div className="h-56 w-full lg:w-1/2">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart aria-label="Referrer breakdown pie chart">
                <Pie
                  data={chartData}
                  cx="50%"
                  cy="50%"
          ...
          <div className="w-full lg:w-1/2">
            <table className="w-full text-sm" aria-label="Referrer breakdown table">
              <thead>
                <tr className="border-b">
                  <th className="text-left py-2 text-gray-500">Source</th>
